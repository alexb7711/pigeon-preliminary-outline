...
#
# Babel properties
#+PROPERTY: header-args:octave :session *octave*
#+PROPERTY: header-args:octave :exports both
...
it consists of both radio systems and autopilot.
...
#+begin_src octave :results output
  ...
  W_a   = Sf*(w_pc + w_mc + w_rad);                # Autopilot weight
...
#+RESULTS:
:
: octave> octave> octave> octave> octave> 147.33
